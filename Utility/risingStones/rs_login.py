...
def rs_get_temp_cookies():
    ...
    headers = {
        ...
        'method': 'GET',
        'path': '/api/home/GHome/isLogin',
        'scheme': 'https',
        'pragma': 'no-cache',
        'cache-control': 'no-cache',
        'accept': 'application/json, text/plain, */*',
        'authorization': '',
        'user-agent': 'Mozilla/5.0 (Linux; Android 12; V2218A Build/V417IR; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/91.0.4472.114 Safari/537.36 DaoYu/9.4.14',
...
def rs_dao_login(sub_account_key, temp_cookies):
    ...
    dao_login_headers = {
        ...
        'cache-control': 'no-cache',
        'accept': 'application/json, text/plain, */*',
        # 'authorization': sub_account_key, //莫名其妙的auth参数 测试一下 先留空
...
def rs_do_login(daoyu_ticket, temp_cookies):
    ...
    if rs_login_json['code'] == 10000:
        ...
        # logger_stream.info(f'当前操作账户：[{rs_login_json["data"]["area_name"]}]'
        #                    f'[{rs_login_json["data"]["group_name"]}]'
        #                    f'[{rs_login_json["data"]["character_name"]}]')
